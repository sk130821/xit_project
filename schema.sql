...
INSERT INTO settings (setting_key, setting_value, description) VALUES
  ...
  ('payment_token_address', '0x55d398326f99059fF775485246999027B3197955', 'BEP-20 USDT on BSC (required for buys)'),
  ('payment_token_symbol', 'USDT', 'Payment token symbol shown in UI'),
  ('chain_id', '56', 'BSC chain ID (56=mainnet, 97=testnet)'),
  ('chain_name', 'BNB Smart Chain', 'Blockchain network display name'),
  ('rpc_url', 'https://bsc-dataseed.binance.org/', 'JSON-RPC URL for blockchain verification'),
  ('block_explorer_url', 'https://bscscan.com', 'Block explorer base URL'),
  ('admin_treasury_wallet', '', 'Admin wallet that receives USDT buy payments'),
  ('admin_payout_wallet', '', 'Admin wallet for sell payouts (uses treasury if empty)'),
  ('token_decimals', '18', 'XIT token decimal places'),
  ('payment_decimals', '18', 'USDT decimals on BSC (18)'),
